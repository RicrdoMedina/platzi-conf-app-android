...
class MainActivity : AppCompatActivity() {
    fun configNav() {
        // Le indicamos donde estar el menu para navegar, en este caso el bottom navigation bnvMenu
        // Navigation.findNavController le pasamos el activity con this y donde se cargaran los fragmentos
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //Asignamos un action bar que es el toolbar que creamos
        //Toolbar del activity_main.xml
